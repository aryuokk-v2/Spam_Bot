...
from Config import STRING, ALIVE_NAME, USERNAME, SUDO, BIO_MESSAGE, CMD_HNDLR, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10
import asyncio
import telethon.utils
from telethon.tl import functions
from telethon.tl.functions.channels import LeaveChannelRequest
from telethon.tl.functions.messages import ImportChatInviteRequest
from plugins.Utils import RAID, RRAID
...
async def start_Destroyer():
    ...
    if one:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await idk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if two:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if three:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if four:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if five:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if six:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await adk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if nine:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if ten:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
...
async def gifspam(e, one):
    try:
        await e.client(
            functions.messages.SaveGifRequest(
                id=types.InputDocument(
                    id=sandy.media.document.id,
                    access_hash=one.media.document.access_hash,
                    file_reference=one.media.document.file_reference,
                ),
                unsave=True,
            )
        )
...
@idk.on(events.NewMessage(incoming=True, pattern=f"{CMD_HNDLR}bio"))
...
print(text)
print("")
print("SMEXYYY!!! DESTROYER SPAM BOT STARTED SUCCESFULLY, JAO GAAND FAAD DO SPAM ME.")
